 ...
 */
public class MyPhotoFolderPw extends MyBasePopupWindow implements BGAOnRVItemClickListener {
    ...
    public MyPhotoFolderPw(Activity activity, View anchorView, Delegate delegate) {
