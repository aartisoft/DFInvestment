        ...
        switch (view.getId()) {
            ...
            case R.id.login_act_button:
                ...
                if (isMobileNO(loginActUsernameEdittext.getText().toString()) && loginActPasswordEdittext.getText().toString().length() >= 6
                    ...
                    loginHttps.getRegisterData(
                            loginActUsernameEdittext.getText().toString()
                            , loginActPasswordEdittext.getText().toString()
                            , registerActVerificationCodeEdittext.getText().toString());
                }
                break;
...
//        Toast.makeText(this, "注册成功，已登录！", Toast.LENGTH_LONG).show();
    }
    ...
    public void registerSuccess() {
        Toast.makeText(this, "注册成功，已登录！", Toast.LENGTH_LONG).show();
        //注册成功是默认登录状态
        EventBus.getDefault().post(EventBusTag.REGISTER_SUCCESS);
        finish();
    }
