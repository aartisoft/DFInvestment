...
public class MyBookRackPresneter {

    private MyBookRackView myBookRackView;

    public MyBookRackPresneter(MyBookRackView myBookRackView) {
        this.myBookRackView = myBookRackView;
    }
        ...
        avObjectAVQuery.findInBackground(new FindCallback<AVObject>() {
            ...
            public void done(List<AVObject> list, AVException e) {
                if (e == null) {
                    ...
                    myBookRackView.geMyBookRackSuccess(arrayList);
//                    lookCatagoryView.getLookCatagorySuccess(arrayList);
                } else {
                    myBookRackView.geMyBookRackFail(e.getMessage());
